...
- 截止后到次日 12:00 前记为补卡，次日 12:00 起仍未交记为旷卡；
- 同一周期统一使用周期第一天作为记录日期；
...
# 截止日的次日：11:00 @ 仍未交成员，12:00 截止并发补交汇总
MAKEUP_REMINDER_ENABLED=true
MAKEUP_REMINDER_HOUR=11
MAKEUP_REMINDER_MINUTE=0
MAKEUP_DEADLINE_HOUR=12
