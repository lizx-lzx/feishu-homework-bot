...
本轮技术周为 2026-08-17—2026-08-26，共 5 次作业，现已结束。课程期间两天一次作业：
...
- 第一天 10:00 发布作业；
- 第二天 20:00 前提交，记为正常提交；
- 第二天 20:00 至第三天 20:00，记为补卡；
- 第三天 20:00 后仍未交，记为旷卡；
- 同一周期统一使用周期第一天作为记录日期。

例如 08-17—08-18 是第 1 次作业，数据库里的 `report_date` 统一写 `2026-08-17`，不会再生成一套 08-18 作业记录。

`COURSE_END_DATE` 是真实的课程生命周期边界。结束日之后，程序不再生成新作业周期，也不再自动发每日简报、催交、未交名单、最终汇总和补交汇总。历史查询、明确写明第 5 次的补交、多维表格及组长人工修正仍可使用；结束后的无标签图片不会被误认成第 6 次作业。
...
# 每次作业第二天 12:00 自动 @ 仍未交的成员
REMINDER_ENABLED=true
REMINDER_HOUR=12
REMINDER_MINUTE=0

# 每次作业第二天 17:00 发未交名单，20:00 发最终汇总
MISSING_LIST_ENABLED=true
MISSING_LIST_HOUR=17
MISSING_LIST_MINUTE=0
FINAL_STATUS_ENABLED=true
...
# 每次作业第三天：17:00 @ 仍未交成员，20:00 发补交汇总并结束补交期
MAKEUP_REMINDER_ENABLED=true
MAKEUP_REMINDER_HOUR=17
MAKEUP_REMINDER_MINUTE=0
MAKEUP_SUMMARY_ENABLED=true
...
# 技术组两天一次作业：第一天 10:00 发布，第二天 20:00 截止
ASSIGNMENT_CYCLE_START_DATE=2026-08-17
COURSE_END_DATE=2026-08-26
ASSIGNMENT_CYCLE_DAYS=2
ASSIGNMENT_PUBLISH_HOUR=10
